...
export function AddUserDialog({ open, onOpenChange }: AddUserDialogProps) {
    ...
    const validateField = (field: string, value: string, allValues?: { password?: string; confirmPassword?: string }) => {
        ...
        switch (field) {
            ...
            case "password":
                ...
                if (fieldTouched.confirmPassword || touched) {
                    ...
                    if (confirmPwd && value !== confirmPwd) newErrors.confirmPassword = "Passwords do not match";
                    else if (confirmPwd && value === confirmPwd) delete newErrors.confirmPassword;
                }
                break;
            case "confirmPassword":
                const pwd = allValues?.password || password;
                if (!value) newErrors.confirmPassword = "Please confirm your password";
                else if (pwd !== value) newErrors.confirmPassword = "Passwords do not match";
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="space-y-2">
                            ...
                            <Select value={selectedOrganization} onValueChange={(value) => {
                                ...
                                <SelectTrigger className={`w-full bg-background text-foreground ${(touched || fieldTouched.organization) && errors.organization ? "border-destructive" : ""}`}>
                            ...
                            {(touched || fieldTouched.organization) && errors.organization && (
                        ...
                        <div className="space-y-2">
                            ...
                            <Select value={selectedRole} onValueChange={(value) => {
                                ...
                                <SelectTrigger className={`w-full bg-background text-foreground ${(touched || fieldTouched.role) && errors.role ? "border-destructive" : ""}`}>
                        ...
                        <div className="space-y-2">
                            ...
                            {(touched || fieldTouched.confirmPassword) && errors.confirmPassword && (
